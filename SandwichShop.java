...
class SandwichShop {
    ...
    public static void main(String[] args) {
        ...
        keyboard.skip("\n");
        if (veggiesSoldToday < goalForVeggies) {
        ...
        if ((veggiesSoldToday >= goalForVeggies) && (burgersSoldToday >= goalForBurgers) && (subsSoldToday >= goalForSubs) && (soupSoldToday >= goalForSoup)) {
